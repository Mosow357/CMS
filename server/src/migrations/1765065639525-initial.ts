...
export class Initial1765065639525 implements MigrationInterface {
    name = 'Initial1765065639525'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "testimonial_invitations" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "email" character varying NOT NULL, "token" character varying NOT NULL, "expires_at" TIMESTAMP NOT NULL DEFAULT now(), "used_at" TIMESTAMP DEFAULT now(), CONSTRAINT "PK_5416fa1619a3d95bf6bc3a786b5" PRIMARY KEY ("id"))`);
